// @ts-nocheck
import TonWeb from "tonweb/src/index"
import { getClient, getKeyPair } from "../getclient"
import { createOffchainUriCell } from "tonweb/src/contract/token/nft/NftUtils"
...
class DnsRoot extends TonWeb.Contract {
  ...
  createDataCell() {
    ...
    cell.bits.writeAddress(
      new TonWeb.Address("EQC3dNlesgVD8YbAazcauIrXBPfiVhMMr5YYk2in0Mtsz0Bz")
    )
    cell.bits.writeAddress(
      new TonWeb.Address("EQCA14o1-VWhS2efqoh_9M1b_A9DtKTuoqfmkn83AbJzwnPi")
    )
    cell.bits.writeAddress(
      new TonWeb.Address("EQB43-VCmf17O7YMd51fAvOjcMkCw46N_3JMCoegH_ZDo40e")
    )
    return cell
  }
}
...
async function init() {
  ...
  console.log(
    "collection address=",
    dnsCollectionAddress.toString(true, true, true)
  )

  const dnsItemAddress = new TonWeb.utils.Address(
    "EQDEwJoXDBqBFI-0pvYJOuI5MEuvYthhwkl56qi5oclHMyGC"
  )
  ...
  const getDnsCollectionInfo = async () => {
    ...
    console.log(
      "addressByIndex=",
      (
        await dnsCollection.getNftItemAddressByIndex(
          new BN(
            "6f0d5e27c981d01ba43aaf3d346a84beb1e8757b988465a325b3217ec3257af6",
            16
          )
        )
    ...
    console.log(
      ...
      (
        await dnsCollection.getNftItemAddressByIndex(
          new BN(
            "b413c774757e648677382bd685a02242640b846f9dc92455a2a044b9c3279d5a",
            16
          )
        )
      ).toString(true, true, true)
    ...
    console.log(
      ...
      (
        await dnsCollection.getNftItemAddressByIndex(
          new BN(
            "8b98cad1bf9de7e1bd830ba3fba9608e6190825dddcf7edac7851ee16a692e81",
            16
          )
        )
      ).toString(true, true, true)
    ...
    console.log(
      await wallet.methods
        .transfer({
          ...
          amount: TonWeb.utils.toNano("0.1"),
          seqno: seqno,
          payload: await TonWeb.dns.DnsItem.createChangeContentEntryBody({
            category: TonWeb.dns.DNS_CATEGORY_WALLET,
            value: TonWeb.dns.createSmartContractAddressRecord(
              new TonWeb.Address(
      ...
      await wallet.methods
        .transfer({
          ...
          payload: await dnsItem.createTransferBody({
            newOwnerAddress: new TonWeb.Address(
              "EQBs7JfxnH2jNAlo0ytfKc77sSHQsUBzofngOkcLZyJlmm3j"
            ),
